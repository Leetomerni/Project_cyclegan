...
if __name__ == '__main__':
    ...
    # templates train/test
    run('python train.py --model templates --name temp2 --dataroot ./datasets/mini_pix2pix --n_epochs 1 --n_epochs_decay 0 --save_latest_freq 10 --display_id -1')
    run('python test.py --model templates --name temp2 --dataroot ./datasets/mini_pix2pix --num_test 1')
